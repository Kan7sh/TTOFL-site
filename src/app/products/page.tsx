...
const testimonials = [
  ...
  {
    quote:
      "This platform will elevate our business by connecting us with customers across multiple societies within a single application, fostering increased demand and growth.",
    name: "Navin",
    title: "Car PPF Vendor",
  },
  {
    quote:
      "Managing our team of cleaners, providing timely customer updates, and tracking car details from start to finish will become seamless, greatly simplifying our operations.",
    name: "Anil",
    title: "Society Vendor",
  },
  {
    quote:
      "Tracking payments and vehicle key handovers to vendors will be effortless, ensuring a smooth and hassle-free experience for residents like me”, Also Having one stop solution to all.",
    name: "Aslam",
    title: "Resident",
  },
];
